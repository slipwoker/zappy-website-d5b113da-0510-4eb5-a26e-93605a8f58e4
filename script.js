        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    submitBtn.textContent = document.dir === 'rtl' ? 'جاري الإرسال...' : 'Sending...';
                    ...
                    setTimeout(() => {
                        ...
                        successMsg.style.cssText = 'background: #48bb78; color: white; padding: 1rem; border-radius: 0.375rem; margin-top: 1rem; text-align: center;';
                        successMsg.textContent = document.dir === 'rtl' ? 'تم إرسال رسالتك بنجاح!' : 'Your message has been sent successfully!';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd5b113da-0510-4eb5-a26e-93605a8f58e4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd5b113da-0510-4eb5-a26e-93605a8f58e4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd5b113da-0510-4eb5-a26e-93605a8f58e4';
